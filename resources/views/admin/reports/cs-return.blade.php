...
@section('title', 'CS Return Report')
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0 text-primary">
                    <i class="bx bx-undo me-2"></i>Commitment Stock Return Report
                </h5>
                    ...
                    <div class="table-responsive" id="mainScroll">
                        <table class="table table-bordered align-middle" id="returnTable">
                            ...
                            <tbody id="returnTableBody">
                                ...
                                @php
                                    $products      = $note->products; // already filtered: returned_status=0
    ...
    @endif
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="text-muted small">
                            ...
                            Showing {{ $commitments->count() }} commitment(s) with returned products &nbsp;|&nbsp;
                ...
                @else
                    <div class="alert alert-info text-center py-5">
                        ...
                        No records found with returned products.
                    </div>
                @endif
            </div>
        </div>
...
#returnTable thead th:last-child { border-right: none !important; }
#returnTable thead .sticky-col { background: var(--brand-primary-lt) !important; color: var(--brand-primary) !important; z-index: 3; }
...
#returnTable tbody td:last-child { border-right: none !important; }
#returnTable tbody tr:last-child td { border-bottom: none !important; }
#returnTable tbody tr.return-row:hover td { background: #fafbff !important; }
#returnTable tbody tr.return-row:hover .sticky-col { background: var(--brand-primary-lt) !important; }

#returnTable .sticky-col {
...
#returnTable .small.text-muted.fw-bold { font-size:12.5px !important; color:var(--text-body) !important; font-weight:600 !important; white-space:normal !important; line-height:1.4 !important; }
    ...
    function sortRows(col, dir) {
        ...
        rows.sort((a, b) => {
            switch (col) {
                ...
                case 'supplier':    return dir === 'asc' ? (a.dataset.supplier||'').localeCompare(b.dataset.supplier||'') : (b.dataset.supplier||'').localeCompare(a.dataset.supplier||'');
                case 'remarks':     return dir === 'asc' ? (a.dataset.remarks||'').localeCompare(b.dataset.remarks||'') : (b.dataset.remarks||'').localeCompare(a.dataset.remarks||'');
        ...
        document.querySelectorAll('#returnTable .sortable').forEach(th => {
