...
return new class extends Migration
{
    public function up()
    {
        ...
        if (Schema::hasTable('medicines')) {
            Schema::table('medicines', function (Blueprint $table) {
                ...
                if (!Schema::hasColumn('medicines', 'alt_supplier_codes')) {
                    $table->text('alt_supplier_codes')->nullable()->after('supplier_name');
                }
        ...
        // Create products table (normalized version)
    ...
    public function down()
    {
        ...
        if (Schema::hasTable('medicines')) {
            Schema::table('medicines', function (Blueprint $table) {
                $columns = [
                    'product_code', 'purchase_price', 'supplier_code', 
                    'supplier_name', 'purchase_unit', 'sale_unit', 
                    'alt_supplier_codes', 'generic_name_original'
                ];
        ...
        if (Schema::hasTable('suppliers')) {
            Schema::table('suppliers', function (Blueprint $table) {
                ...
                if (Schema::hasColumn('suppliers', 'alt_supplier_code')) {
                    $table->dropColumn('alt_supplier_code');
                }
            });
        }
    }
